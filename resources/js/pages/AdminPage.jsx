...
export default function AdminPage() {
    const { theme } = useTheme(); const [stats, setStats] = useState(null); const [loading, setLoading] = useState(true);
    ...
    const g = theme === "dark" ? "#374151" : "#e5e7eb"; const t = theme === "dark" ? "#9ca3af" : "#6b7280";
    const ts = { backgroundColor: theme === "dark" ? "#1f2937" : "#fff", border: `1px solid ${g}`, borderRadius: "8px", color: theme === "dark" ? "#fff" : "#111827" };

    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
            <AnimateIn animation="fade"><h1 className="text-2xl font-bold text-content-primary mb-8">Administrācija</h1></AnimateIn>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 mb-10">
                {[{ l: "Kopā", v: stats.general.total_cars }, { l: "Aktīvie", v: stats.general.active_cars, c: "text-status-success" },
                    ...
                    { l: "Vid. nobrauk.", v: `${Number(stats.general.avg_mileage).toLocaleString("lv-LV")} km` }]
                    .map((s, i) => (
