            ...
            <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div className="lg:col-span-2 space-y-6">
                            ...
                            <button
                                onClick={async () => {
                                    try {
                                        ...
                                        alert(
                                            "Pieteikums nosūtīts pārdevējam!",
                                        );
                                    } catch (err) {
                                        alert(
                    ...
                    <div className="bg-surface-secondary rounded-xl border border-border p-5">
                        <h2 className="text-content-primary font-semibold mb-4">
                            Parametri
                        </h2>
                        <div className="grid grid-cols-2 gap-y-3 gap-x-4 text-sm">
                            <div className="text-content-muted">Gads</div>
                            <div className="text-content-primary">
                                {car.year}
                            </div>
                            <div className="text-content-muted">Nobraukums</div>
                            <div className="text-content-primary">
                                {Number(car.mileage).toLocaleString("lv-LV")} km
                            </div>
                            <div className="text-content-muted">Dzinējs</div>
                            <div className="text-content-primary">
                                {fuelLabels[car.fuel_type]}
                            </div>
                            <div className="text-content-muted">Ātrumkārba</div>
                            <div className="text-content-primary">
                                {transmissionLabels[car.transmission]}
                            </div>
                            <div className="text-content-muted">Virsbūve</div>
                            <div className="text-content-primary">
                            ...
                            <div className="text-content-muted">Krāsa</div>
                            <div className="text-content-primary">
                                {car.color}
                            </div>
                        </div>
                    ...
                    {car.user && (
                        <div className="bg-surface-secondary rounded-xl border border-border p-5">
                            <h2 className="text-content-primary font-semibold mb-3">
                                Pārdevējs
                            </h2>
                    ...
                    {user &&
                        (car.user_id === user.id || user.role === "admin") && (
                            <Link
                                to={`/cars/${car.id}/edit`}
