            ...
            <section className="relative bg-gradient-to-br from-surface-secondary via-surface-primary to-surface-secondary py-20 sm:py-32">
                ...
                <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
                    ...
                    <form onSubmit={handleSearch} className="max-w-2xl mx-auto flex gap-3">
                        ...
                        <button type="submit" className="bg-accent hover:bg-accent-hover text-content-inverted px-8 py-4 rounded-xl font-bold text-lg transition-colors whitespace-nowrap">
                            Meklēt
                        </button>
                    </form>
