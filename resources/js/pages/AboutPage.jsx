        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
            ...
            <AnimateIn delay={150}>
                <div className="bg-surface-secondary border border-border rounded-xl p-8 mb-8">
                    <h2 className="text-xl font-semibold text-content-primary mb-4">ABUY — uzticama lietotu auto platforma</h2>
                    <p className="text-content-secondary leading-relaxed mb-4">ABUY ir moderna tiešsaistes platforma lietotu automašīnu pirkšanai un pārdošanai Latvijā. Mūsu mērķis ir padarīt lietotu transportlīdzekļu tirgu drošāku, pārskatāmāku un ērtāku gan pircējiem, gan pārdevējiem.</p>
